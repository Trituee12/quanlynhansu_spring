          ...
          <section class="wrapper ">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel ">
                      ...
                      <f:form class="form-horizontal style-form" action="updatepb" modelAttribute="suapb" method="POST">
                          
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><s:message code="label.pb.mapb"  /></label>
                              <div class="col-sm-10">
                                  <input type="text" readonly="true"  class="form-control round-form" name="maphong" value="${suapb.maphong}">
                              </div>
                          </div>
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label"><s:message code="label.pb.tenpb"  /></label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="tenphong"  value="${suapb.tenphong}">
                                   <p>${errorpb1}</p>
                              </div>
                          </div>
